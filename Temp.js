...
(function () {
    ...
    let toolkitUnlocked = true; // 🔒 passcode gate (once per page load) - change to false when setting up passcode
    ...
    function destroyToolkit() {
        ...
        lastPosts = null;
        toolkitUnlocked = true; // Change to false when setting up passcode
    }
...
>
  ...
  <g>
    ...
    />
            ...
            <div class="small-label">v0.x.x — WLDR Toolkit</div>
        `;
